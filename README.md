...
|---------|--------|-----------|
| Latest Model | GPT-4 Turbo | Claude 3.5 Sonnet |
| Context Window | Up to 128k tokens | Up to 200k tokens |
| Starting Price | $10/1M input tokens | $3/1M input tokens |
...
⭐ Star this repo to follow along as I add more comparisons.
...
**Status:** 🚧 Work in Progress - New content added weekly
